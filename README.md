...
|---|---|---:|---|
| [Reentrancy Demo](reports/001-reentrancy-demo.md) | Educational case study | High | Complete |
...
For security research or collaboration, contact [@DefiAudit on X](https://x.com/DefiAudit) or [@amino0594 on Telegram](https://t.me/amino0594).
